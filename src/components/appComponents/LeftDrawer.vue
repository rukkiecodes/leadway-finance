  ...
  <v-navigation-drawer border="0" v-model="drawer">
    <template v-slot:prepend>
      ...
      >
        ...
        <span class="text-body-2 text-sm-body-1 text-md-h6 font-weight-black">{{ profile?.firstName }} {{ profile?.lastName }}</span>
      </v-sheet>
    </template>
    ...
    <v-expansion-panels elevation="0" density="compact">
      <v-expansion-panel>
        <v-expansion-panel-title> Live Analytics </v-expansion-panel-title>
