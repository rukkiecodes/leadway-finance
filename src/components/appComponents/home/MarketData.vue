  ...
  <v-card>
    ...
    <v-card-text class="pa-0">
      <iframe
        ...
        lang="en"
        style="user-select: none; box-sizing: border-box; display: block;"
      />
    </v-card-text>
  </v-card>
</template>
