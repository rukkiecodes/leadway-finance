    ...
    <v-sheet max-width="1200" class="mx-auto" color="transparent" dark>
      <v-row>
        ...
        <v-col cols="12" sm="8" class="mt-sm-16">
          <v-row>
            <v-col cols="12" sm="6">
              <router-link to="/admin/account/updateContactInformation" class="text-decoration-none">
            ...
            <v-col cols="12" sm="6">
              <router-link to="/admin/account/updateAvatar" class="text-decoration-none">
                <v-sheet rounded="lg" class="pa-2 d-flex align-center ga-4">
            ...
            <v-col cols="12" sm="6">
              <router-link to="/admin/account/updatePassword" class="text-decoration-none">
                <v-sheet rounded="lg" class="pa-2 d-flex align-center ga-4">
            ...
            <v-col cols="12" sm="6">
              <router-link to="/admin/account/updateEmail" class="text-decoration-none">
                <v-sheet rounded="lg" class="pa-2 d-flex align-center ga-4">
                  <v-sheet width="50" height="50" color="indigo" class="d-flex justify-center align-center" dark
                           rounded="lg"
                  >
            ...
            <v-col cols="12" sm="6">
              <router-link to="/admin/account/viewNotifications" class="text-decoration-none">
                <v-sheet rounded="lg" class="pa-2 d-flex align-center ga-4">
                  <v-sheet width="50" height="50" color="indigo" class="d-flex justify-center align-center" dark
                           rounded="lg"
                  >
