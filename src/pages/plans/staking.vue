<template>
  <v-container>
    <h1 class="text-center mb-16">Staking Plans</h1>

    <v-row class="mb-16">
      <v-col v-for="(price, index) in miningPlan.prices" :key="index" cols="12">
        <v-card>
...
const miningPlan = computed(() => plans.find(plan => plan.use.toLowerCase() === 'staking'));
